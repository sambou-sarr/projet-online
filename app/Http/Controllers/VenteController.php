...
class VenteController extends Controller
{
    ...
    public function donne_du_jour(){
        ...
        $r1 = Vente::where('created_at', 'like', "$today%")->sum('montant');
        $r0 = Vente::selectRaw('produit, COUNT(produit) ')->groupBy('produit')->orderByDesc('COUNT(produit)')->first();
        $r3 = Vente::selectRaw('produit, DISTINCT ')->COUNT('produit');
